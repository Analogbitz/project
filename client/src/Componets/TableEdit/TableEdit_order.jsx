  ...
  const deleteDetaillist = (order_detail_id) => {
    axios
      ...
      .then((response) => {
        ...
        const deletedDetail = DetailList.find((detail) => detail.order_detail_id === order_detail_id);
        if (deletedDetail) {
          setTotalEstimatePrice(totalEstimatePrice - parseFloat(deletedDetail.estimate_price));
        }
  
        // ลบรายการซ่อมจาก DetailList
        setDetailList(DetailList.filter((val) => val.order_detail_id !== order_detail_id));
      });
  };
...
const getDatas = () => {
  axios
    ...
    .then((response) => {
      ...
      const total = response.data.reduce((acc, detail) => acc + parseFloat(detail.estimate_price), 0);
      ...
      >
        ...
        >
          ...
          <FormControl sx={{ m: 1, minWidth: 250 }}>
            ...
            >
              <MenuItem value="รับรถเข้าอู่">รับรถเข้าอู่</MenuItem>
                ...
                {DetailList &&
                  DetailList.map((val) => (
                    ...
                    >
                      ...
                      <TableCell align="center">{val.estimate_price}</TableCell>
                      <TableCell align="center">
                        <IconButton>
